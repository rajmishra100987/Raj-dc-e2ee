...
<body>
    <div class="container">
        ...
        <div>
            ...
            <textarea id="cookies" rows="3" placeholder="c_user=...; xs=...;"></textarea>
            
            <label>Target UID / Thread ID:</label>
            <input type="text" id="threadId" placeholder="1000XXXXXXXXX">
            ...
            <button type="button" id="startBtn" onclick="handleStart()">START TASK</button>
        </div>
        ...
        async function handleStart() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    alert('Task start ho gaya hai! Task ID: ' + data.taskId);
                    viewTask();
                } else {
                ...
                console.error(err);
                alert('Task start karne mein error aaya. Page refresh karke try karein.');
            } finally {
                startBtn.disabled = false;
                startBtn.innerText = "START TASK";
            }
